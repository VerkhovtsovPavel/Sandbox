...
public class DeckFactory {
    ...
    public Deck thirtySixCardsDeck() {
        List<Card> cards = combinations(Suit.values(),
                new Value[]{Value.SIX, Value.SEVEN, Value.EIGHTH, Value.NINE, Value.TEN, Value.JACK, Value.QUEEN, Value.KING, Value.ACE});
    ...
    private List<Card> combinations(Suit[] suits, Value[] values) {
