...
public final class Application {
    ...
    public static void main(String[] args) {
        ...
        times(Configuration.INVESTORS_AMOUNT, () -> investors.add(new Investor(Configuration.BEGINNING_WEALTH, Configuration.INVESTING_FACTOR)));
        ...
        printPercentiles(wealthValues, DoubleConstant.HALF, DoubleConstant.ZERO_SIX, DoubleConstant.ZERO_SEVEN, DoubleConstant.ZERO_EIGHTH, DoubleConstant.ZERO_NINE, DoubleConstant.ZERO_NINETY_FIVE,
