...
import my.sandbox.salad.constant.SortCriteria;

import static my.sandbox.salad.constant.IngredientsLibrary.CUCUMBER;
import static my.sandbox.salad.constant.IngredientsLibrary.OLIVE_OIL;
import static my.sandbox.salad.constant.IngredientsLibrary.SALT;
import static my.sandbox.salad.constant.IngredientsLibrary.TOMATO;
